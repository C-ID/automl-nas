...
class Distribution(ABC):
    ...
    @abstractmethod
    def log_prob_from_params(self, *args, **kwargs) -> th.Tensor:
        """
...
@DISTRIBUTIONS.register('DiagGaussianDist')
...
@DISTRIBUTIONS.register('SquashedDiagGaussianDist')
class SquashedDiagGaussianDistribution(DiagGaussianDistribution):
    ...
    def log_prob(self, actions, gaussian_actions) -> th.Tensor:
        # Inverse tanh
...
@DISTRIBUTIONS.register('CategoricalDist')
...
@DISTRIBUTIONS.register('MultiCategoricalDist')
class MultiCategoricalDistribution(Distribution):
    ...
    def proba_distribution(self, action_logits: th.Tensor) -> "MultiCategoricalDistribution":
        self.distribution = [Categorical(logits=split) for split in th.split(action_logits, tuple(self.action_dim), dim=1)]
        return self
...
@DISTRIBUTIONS.register('BernoulliDist')
...
@DISTRIBUTIONS.register('StateDependentNoiseDist')
