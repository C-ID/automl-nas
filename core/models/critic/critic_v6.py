...
@CRITIC.register("LinkCritic")
class LinkCritic(nn.Module):
    """
        Critic network.
    ...
    def __init__(
        ...
        super(LinkCritic, self).__init__()
    ...
    def _build_arch(self, backbone, neck, cls_head):
        # init total network
        assert isinstance(backbone, dict) and isinstance(neck, dict) and isinstance(cls_head, dict)
