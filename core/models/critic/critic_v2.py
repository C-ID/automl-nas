...
@CRITIC.register("ScableCritic")
class ScableCritic(nn.Module):
    """
        Critic network.
    ...
    def __init__(
        ...
        super(ScableCritic, self).__init__()
        ...
        self.stem = nn.Sequential(
            ...
            nn.Conv2d(backbone.C_in//2, backbone.C_in//2, kernel_size=1, stride=2, bias=False),
            nn.BatchNorm2d(backbone.C_in//2),
            nn.ReLU(inplace=True),
            nn.Conv2d(backbone.C_in//2, backbone.C_in, kernel_size=3, stride=1, padding=1, bias=False),
