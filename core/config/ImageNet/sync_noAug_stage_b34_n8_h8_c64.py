...
topo_nums = [34, 8, 8]                         # Three topo graph, construct whole picture
state_space = [int(34*33/2+8*7/2+8*7/2), 5]     #  i.e. dims = [[topo[0]*(topo[0]-1))/2 , 5],
                                              #               [topo[1]*(topo[1]-1))/2 , 5],
                                              #               [topo[2]*(topo[2]-1))/2 , 5]
cls_num=1000
Space = dict(
...
work_dir = 'ImageNet/stage_noAug_b34'
