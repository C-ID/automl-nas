...
c_optim = dict(
    optimizer=dict(type='SGD', lr=0.25, momentum=0.95, weight_decay=0.0003),
    optimizer_config=dict(grad_clip=dict(max_norm=35, norm_type=2)),
)
a_optim = dict(
    optimizer=dict(type='Adam', lr=0.1, betas=(0.5,0.999), weight_decay=0.0003),
)
